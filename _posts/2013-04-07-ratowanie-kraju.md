...
Bo okazuje się, że każdy doskonale "wie" co jest "nie tak", czyja to wina, która parta doprowadza kraj do ruiny, itd.
...
W gronie Polaków nie trzeba długo czekać na zażartą polemikę o sytuacji do jakiej dopuścił rząd/partia/premier czy inny "winowajca dnia", odpowiedzialnego za tą czy inną reformę, ustawę, itd. Jałowa dyskusja, popsuta atmosfera, a argumentów brak.
...
Czy z niewiedzy czy zaniedbania - jako obywatel jestem współodpowiedzialny za los obywateli - i dlatego jestem wdzięczny tym, co dzielą się tą odpowiedzialnością i wykonują robotę, której nie muszę (mogąc koncentrować się na innej specjalizacji). W każdym zawodzie jest ciężko być wybitnym - i nie zawsze wychodzi.

Jeśli w rządzie są ludzie złośliwie i złodzieje - są na pewno też ludzie życzliwi i chętni do pomocy. Zatem zauważanie tylko tych pierwszych świadczy raczej o braku obiektywizmu.

Rozumiem też, że zawód polityka to jeden z najbardziej niewdzięcznych zawodów. Bardziej niż adwokat czy policjant. Powszechnie powodów do dumy mają niewiele.
...
Więc, jeśli ktoś chce mnie rozliczać z mojego obowiązku obywatelskiego (np. że nie głosuje lub nie interesuje się polityką) ... to najpierw niech się rozliczy z własnego obowiązku obywatelskiego - w pełnym zakresie. A nie tylko oglądanie kampanii wyborczej, głosowanie raz na kilka lat, zrzekania się całej faktycznej odpowiedzialności i stękania jak jest źle i komu ściąć głowę.
...
A mamy narzekanie zamiast analizy, krytykę zamiast wniosków, pretensje zamiast listy kroków do celu, złość zamiast planu, oskarżenia bez dowodów, naśmiewanie zamiast wyrozumiałość, wyrzuty zamiast wdzięczności, gadanie zastępuje zdobywanie wiedzy, wymienianie krzywd zamiast branie odpowiedzialności ...
...
Polityka powoduje, że ludzie koncentrują się na tym kto co mówi (co zależy tylko od tego, co może przyciągnąć więcej wyborców) zamiast co faktycznie można zrobić w kraju bez rozwalenia czegoś w innym miejscu.
...
Taka po prostu funkcja tych dwóch opiniotwórzych źródeł nieistotnych informacji.
...
Ano właśnie. Tego, co przy zadaniu tekstowym.
...
Brakuje chociażby jasno zdefiniowanego problemu!
...
A bez tego nawet nie ma dyskusji.
...
Sam przyznam, że nie znam największego problemu w naszych obecnych realiach. Dlatego jedyny na jaki mogę szczerze narzekać, to na negatywne postawy innych. Ale to przecież też nie pomaga - choć przyznam, że wolę polemikę niż, aby ludzie żalili się do ściany gdy jestem w pobliżu.


## Więc co dalej?

Samo zdefiniowanie problemu jest przytłaczające i poza moimi kompetencjami. Chętnie bym odpłatnie zlecił badanie tego tematu (na ile mogę) i wspierałbym - o ile ktoś się tym zajmie rzetelnie i na serio (inaczej wolę czas i pieniądze inwestować w siebie i moją firmę - co dałoby mi większe pole do manewru gdyby mnie naszło zająć się tym samemu kiedyś).
...
"Problem ZUS" nie jest definicją problemu. Zarówno ZUS jak i państwo tylko pośredniczą w transferze pieniędzy z jednego miejsca na drugie - a mi osobiście ciężko pojąć i poskładać dane, aby chociaż to przedstawić, a co dopiero przeanalizować. Jeśli problem dotyczy pieniędzy - to nasuwa się śledzenie ich przepływu. Nawet jeśli większość pieniędzy na ZUS trafia do ostatecznie podatników (lub banków - nie znam proporcji), to nie jest to złe, pod warunkiem, że podatnicy dokonują dobrych wyborów - jako konsumenci lub inwestorzy. Chyba, że np. korzystają z wypłat prawie w całości płacąc raty zaciągniętych kredytów. No i nie potrafię przewidzieć co będzie za rok - czy ZUS rozleci się (i może nawet to wyjdzie na dobre o ile to nie zostawi emerytów/rencistów na lodzie), czy rząd dostanie kolejne pożyczki czy może Polska załata to inflacją pod groźbą kar od Unii, itd.
